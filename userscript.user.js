...
addGlobalStyle(".leftBottomHolder {top:90px;bottom:11px;}.pSt{background-image: linear-gradient(#949494, #545454);width: 140px;letter-spacing: 1px;margin-right: 0px;margin-left: 0px;border-radius: 0px;color: #ffce85;text-shadow:0px 0px 2px #000000, 0px 0px 5px #000000, 0px 0px 8px #000000, -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000, 0px 0px 1px #000000 !important;}")
